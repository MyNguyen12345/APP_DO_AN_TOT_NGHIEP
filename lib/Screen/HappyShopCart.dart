    ...
    return Card(
      ...
      child: InkWell(
        child: Row(
          children: <Widget>[
            Hero(
                tag: getProductCartController.state![index].product.productName,
                child: CachedNetworkImage(
                  imageUrl: "https://datn123.herokuapp.com/" +
                      getProductCartController.state![index].product.avatar,
                  height: 90.0,
                  width: 90.0,
                )),
            Expanded(
                    ...
                    Row(
                      children: [
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              getProductCartController
                                  .state![index].product.productName,
                              style: TextStyle(
                                  color: Colors.black,
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            deleteCart(
                                getProductCartController.state![index].cartId);
                          },
                        )
                      ],
                    ),
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            " (" +
                                getProductCartController
                                    .state![index].product.priceProduct
                                    .toString() +
                                ")",
                            // style: Theme.of(context).textTheme.overline,
                          )
